      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="{{url('admin/pregunta')}}">
                <i class="fa fa-list-alt"></i>
                <span>Ingreso de Preguntas</span>
              </a>
            </li>
            <li class="treeview">
              <a href="{{url('admin/examen')}}">
...
<!--                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>-->
      ...
      <!--Preguntas-->
      <script src="{{asset('js/admin/registro1.js')}}"></script>
      ...
      <script src="{{asset('js/admin/reporte2.js')}}"></script>
      <script src="{{asset('js/admin/reporte3.js')}}"></script>
      <script src="{{asset('js/admin/reporte4.js')}}"></script>
    <!-- jQuery 2.1.4 -->
