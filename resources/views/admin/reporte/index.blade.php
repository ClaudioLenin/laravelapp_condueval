      ...
      <div id="collapsible-panels">
          ...
          <div class="card-body" id="contenido-1">
            ...
            <div class="col-lg-12 p-4">
                ...
                <div class="col-lg-6">
                    <p>Periodo</p>
                    <select id="periodo1" name="periodo" class="form-control">
                    </select>
                </div>
                <div class="col-lg-6">
                    <p>Sección</p>
      ...
      <div id="collapsible-panels">
          ...
          <div class="card-body" id="contenido-2">
            ...
            <div class="col-lg-12 p-4">
                ...
                <div class="col-lg-6">
                    <p>Periodo</p>
                    <select id="periodo2" name="periodo" class="form-control">
                    </select>
                </div>
                <div class="col-lg-6">
                    <p>Sección</p>
            ...
            <div class="col-sm-12 p-4 table-responsive" id="contenido_2">
              ...
              <div class="col-lg-12 descarga p-4 text-right">
                  <form method="get" action="{{route('reporte_evaluaciones2')}}" target="_blank">
      ...
      <div id="collapsible-panels">
          ...
          <div class="card-body" id="contenido-3">
            <div class="col-lg-12 p-4">
                ...
                <div class="col-lg-6">
                    <p>Periodo</p>
                    <select id="periodo3" name="periodo" class="form-control">
                    </select>
                </div>
                <div class="col-lg-6">
                    <p>Sección</p>
            ...
            <div class="col-sm-12 p-4 table-responsive" id="contenido_3">
              <div class="col-sm-12 p-4">
                ...
                <div class="col-lg-12 descarga p-4 text-right">
                    <form method="get" action="{{route('reporte_estudiantes2')}}" target="_blank">
      ...
      <div id="collapsible-panels">
          ...
          <div class="card-body" id="contenido-4">
            <div class="col-lg-12 p-4">
                ...
                <div class="col-lg-6">
                    <p>Periodo</p>
                    <select id="periodo4" name="periodo" class="form-control">
                    </select>
                </div>
                <div class="col-lg-6">
                    <p>Sección</p>
