  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title">Modificar Pregunta de Selección Multiple</h4>
          ...
          <div class='col-lg-12' id='tipo_pregunta'>
              ...
              <div class='table-responsive'>
                  ...
                  <table id='tabla_dinamica' class='col-lg-12'>
                      <div class='col-xs-12' id="correctas{{$pregunta->codpregunta}}">
                      </div>
                      <div class='col-xs-12' id="incorrectas{{$pregunta->codpregunta}}">
                      </div>
                  </table>
              </div>
              <div class='col-lg-12'>
