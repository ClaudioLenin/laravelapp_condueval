  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title">Modificar Pregunta de Verdadero/Falso</h4>
      ...
      <form enctype="multipart/form-data" id="task-edit-{{$pregunta->codpregunta}}" method="POST">
          ...
          <div class='col-lg-12'>
              ...
              <div class='table-responsive'>
                  ...
                  <div class='form-check'>
                      <input type='radio' name='seleccion' id='verdadero{{$pregunta->codpregunta}}' value='verdadero'>
                      <label class='form-check-label' for='verdadero'>Verdadero</label>
                      <br>
                      <input type='radio' name='seleccion' id='falso{{$pregunta->codpregunta}}' value='falso'>
        ...
        <div class="modal-footer text-center col-lg-12" style="text-align:center;justify-content:center">
            ...
            <button type="submit" class="btn btn-primary btn-separacion" value="Modificar" id="Modificar" name="Modificar">Modificar</button>
        </div>
      </form>
    </div>
  </div>
