		...
		<div class="row">
          ...
          <div class="profile-img d-flex justify-content-center">
            ...
            <h3 class="card-title d-flex justify-content-center"><b>DATOS DE USUARIO</b></h3>
						<h4 class="card-text"><b>Nombre: </b>{{session('nombre')}}</h4>
            ...
            <h4 class="card-text"><b>Descripción: </b>{{$user->descripcion}}</h4>
						<div class="form-group d-flex justify-content-center">
							<a href="{{URL::action('Admin\AdminController@edit',$user->codusuarios)}}"><button class="btn btn-info">Editar</button></a>
						</div>
					</div>
				</div>
				@endforeach
